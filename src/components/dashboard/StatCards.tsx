    ...
    <>
      <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
        ...
        <motion.div
          ...
          className="md:col-span-2 relative overflow-hidden hallmark-card p-6 flex flex-col justify-between"
        >
          {/* Subtle Ambient Glow */}
              ...
              <div className="mt-6 flex flex-col sm:flex-row sm:items-baseline justify-between gap-4">
                <div>
                  <div className="flex items-baseline gap-2">
                    <span className="text-4xl sm:text-5xl font-black tracking-tight text-slate-900 dark:text-slate-100">
        ...
        <div className="space-y-5 flex flex-col justify-between">
          ...
          <motion.div
            ...
            className="hallmark-card p-5 space-y-3"
          >
            <div className="flex items-center justify-between">
            ...
            <div className="grid grid-cols-2 gap-2 pt-1">
              <div className="p-2.5 rounded-xl bg-slate-50 dark:bg-slate-800/60 text-[11px]">
          ...
          >
            ...
            <div className="mt-3 w-full h-2.5 rounded-full bg-slate-100 dark:bg-slate-800 overflow-hidden">
              <div
                ...
                style={{ width: `${stats.totalReadings > 0 ? stats.targetComplianceRate : 0}%` }}
              ></div>
            </div>
