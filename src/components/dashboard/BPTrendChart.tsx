...
export const BPTrendChart: React.FC<BPTrendChartProps> = ({ readings }) => {
  ...
  return (
    <motion.div
      ...
      className="rounded-3xl bg-white dark:bg-slate-900 border border-slate-200/80 dark:border-slate-800 p-6 shadow-xl shadow-slate-200/40 dark:shadow-none space-y-4"
    >
      ...
      {chartData.length > 0 ? (
        ...
        <div className="h-64 flex flex-col items-center justify-center text-center p-6 border-2 border-dashed border-slate-200 dark:border-slate-800 rounded-2xl">
          ...
          <p className="text-xs text-slate-400 mt-1">
            Coba ubah filter rentang tanggal di atas atau tambahkan catatan tensi baru.
          </p>
        </div>
      )}
